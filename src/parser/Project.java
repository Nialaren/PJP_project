...
// SYMBOL
    final public Expression factor() throws ParseException {
        ...
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            ...
            case ID:
                ...
                if (true) {
                    return table.getVariable(lineCounter, columnCounter, t.toString());
                }
            }
            break;
            case STRING_LITERAL:
    ...
    private boolean jj_3_7() {
        ...
        if (jj_scan_token(TERMAL_OPERATOR)) {
            return true;
        }
        return false;
    }
    ...
    private boolean jj_3R_9() {
        ...
        if (jj_scan_token(CHOOSE_OPERATOR)) {
            return true;
        }
        if (jj_3R_7()) {
            return true;
